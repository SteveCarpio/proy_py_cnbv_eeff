...
# ----------------------------------------------------------------------------------------------
# Librerias invocadas en los PASOS del programa :                 # Ma P0 P1 P2 P3 P4 P5 P6 P7 #
import os                                                         # Ma p0 -- p2 -- p4 p5       #
import sys                                                        # Ma -- -- -- -- p4          #
import glob                                                       # -- p0 -- p2 -- p4          #
import time                                                       # -- -- p1                   #
import pandas as pd                                               # -- -- -- p2 p3 p4 p5    p7 #
import subprocess                                                 # -- -- -- -- p3             #
import openpyxl                                                   # -- -- -- -- -- -- p5    p7 #
import smtplib                                                    # -- -- -- -- -- -- -- p6    #
import re                                                         # -- -- -- -- -- -- -- p6    #
import oracledb                                                   # -- -- -- -- -- -- -- -- p7 #  
from pathlib import Path                                          # -- -- -- -- -- -- -- -- p7 #  
