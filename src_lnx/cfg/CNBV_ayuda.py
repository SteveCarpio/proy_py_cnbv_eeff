...
def sTv_ayuda():
    ...
    print(Fore.WHITE + "    IP: 10.10.30.7 (Python)")
    print(Fore.WHITE + "    Usuario: Cont: Steve")
    print(Fore.WHITE + "    Contraseña: Gestionada por Cerberus")
    print("")
    print(Fore.WHITE + "Ruta raíz:")
    print(Fore.WHITE + "    /srv/apps/MisCompilados/PROY_CNBV_EEFF/")
    print("")
    print(Fore.WHITE + "Ejecución:")
    print(Fore.WHITE + "    CNV_EEFF.sh ")
    print("")
    print(Fore.WHITE + "Parámetros: Se admite 1, 2 o 5 parámetros; ejemplo:")
    print(Fore.WHITE + "    Parámetro 0 -=> [vació]      : Muestra el menú actual y se procesa en modo DEV")
    print(Fore.WHITE + "    Parámetro 1 -=> ?            : Muestra la ayuda del programa")
    print(Fore.WHITE + "    Parámetro 1 -=> PRO          : Se procesará todos los emisores que estén activos en la CNBV")
    print(Fore.WHITE + "    Parámetro 1 -=> DEV          : Se procesará solo 10 emisores para hacer una previsualización")
    print(Fore.WHITE + "    Parámetro 2 -=> [1,2,3]      : Tipo de Descarga (Trimestral, Mensual, Anual)")
    print(Fore.WHITE + "    Parámetro 3 -=> [1,2,3,4,4D] : Trimestre del Año")
    print(Fore.WHITE + "    Parámetro 4 -=> [year]       : Año de ejercicio")
    print(Fore.WHITE + "    Parámetro 5 -=> [1,2]        : Tipo de fichero (Excel, Pdf)")
    print("")
    ...
    print(Fore.WHITE + "        Este paso abrirá el navegador Chrome y será ejecutado automáticamente en modo handless")
    ...
    print(Fore.WHITE + "  Versión 4 - 2025")
    print(Fore.MAGENTA + "=" * 94)