...
def sTv_ayuda():
    ...
    print(Fore.WHITE + "        adjunto se mandará el excel y una tabla descriptiva en el cuerpo del email ")
    ...
    print(Fore.WHITE + "        Se debe tener activo el SMTP de TDA para el envío de correos con files adjuntos")
    print("")
